...
public class Detector {
    ...
    public static boolean USE_ADAPTIVE = false;
    public static boolean DEBUG_PREP_FRAME = false;
    public static boolean DEBUG_CONTOURS = false;
    public static boolean DEBUG_POLY = false;
    public static boolean DEBUG_DRAW_MARKERS = false;
    public static boolean DEBUG_DRAW_MARKER_ID = false;
    public static boolean DEBUG_DRAW_SAMPLING = false;
